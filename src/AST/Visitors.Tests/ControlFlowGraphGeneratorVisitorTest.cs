...
namespace AST.Tests
{
    public class ControlFlowGraphGeneratorVisitorTests
    {
        ...
        //     var block = new BlockStmt(new List<Statement> { assignment1, assignment2 });
        ...
        //     var innerBlock = new BlockStmt(new List<Statement> 
        //     { 
        //         assignment2, 
        //         assignment3 
        //     });
        ...
        //     var level3Block = new BlockStmt(new List<Statement> { assignment4 });
        //     var level2Block = new BlockStmt(new List<Statement> { assignment3, level3Block });
        //     var level1Block = new BlockStmt(new List<Statement> { assignment2, level2Block });
        //     var outerBlock = new BlockStmt(new List<Statement> { assignment1, level1Block });
        ...
        //     var innerBlock = new BlockStmt(new List<Statement> { assignment1 });
        //     var outerBlock = new BlockStmt(new List<Statement> { innerBlock, assignment2 });
        ...
        //     var outerBlock = new BlockStmt(new List<Statement> { innerBlock });
        //     visitor._cfg = new CFG();
        //     visitor.isStart = false;
        ...
        //     var visitor = CreateVisitor();
        //     var assignment1 = CreateAssignment("x", 5);
        //     var block1 = new BlockStmt(new List<Statement> { assignment1 });
            
        //     var assignment2 = CreateAssignment("y", 10);
        //     var block2 = new BlockStmt(new List<Statement> { assignment2 });
