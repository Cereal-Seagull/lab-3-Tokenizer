...
namespace Parser.Tests
{
  ...
  return (a)
        ...
        public void Parse_MissingBraces_ThrowsParseException()
        {
            ...
            Assert.Contains("must begin with", exception.Message, StringComparison.OrdinalIgnoreCase);
        }
        ...
        public void Parse_InvalidSyntax_ThrowsParseException()
        {
            ...
            // Act & Assert
            var exception = Assert.Throws<ParseException>(() => Parser.Parse(program));
			Assert.Contains("syntax invalid", exception.Message, StringComparison.OrdinalIgnoreCase);
        }
